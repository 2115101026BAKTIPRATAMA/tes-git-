...
<div class="w3-container">
    <h5 class="w3-opacity"><b><?php echo e($item->title); ?></b></h5>
    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo e($item->desc); ?></h6>
    <!-- <p><?php echo e($item->desc); ?></p> -->
    <tr>
        <td>Category</td>
        <td>:</td>
        <td class="w3-large"><b><?php echo e($item->Olahan_id); ?></b></>
    </tr>
    <hr>
</div>
...
</html><?php /**PATH C:\Users\Bakti Pratama\Documents\Kecak\kecak\resources\views/admin/detailbooking.blade.php ENDPATH**/ ?>