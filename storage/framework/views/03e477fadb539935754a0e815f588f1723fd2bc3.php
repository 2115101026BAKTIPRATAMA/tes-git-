...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12 mt-12">
            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex items-baseline justify-between pt-2 pb-6 border-b border-gray-200">
                        <h1 class="text-4xl font-bold tracking-tight text-gray-900">DETAIL PEMESANAN</h1>
        ...
        <section>
                ...
                <form class="p-6">
                    ...
                    <form action="">
                       <table>
                        <br>
                        <tr>
                         <td class="font-bold">FORM PEMESANAN</td>
                        </tr>
                        <tr>
                        <td>Nama</td>
                        <td>:</td>
                        <td><input type="text" name="nama" value="" placeholder="Tulisakan Nama Anda" /></td>
                        </tr>
                        <td>jenis_kelamin</td>
                        <td>:</td>
                        <td>
                        ...
                        <td>No.Rek</td>
                        <td>:</td>
                        <td><input type="text" name="nama" value="" placeholder="Tulisakan No.Rek Anda" /></td>
                        </tr>
                        
                        <tr>
                            <td>
                            <button type="button" class="inline-block bg-violet-600 rounded-full px-6 h-10 py-2 mx-4 text-xs font-medium leading-tight text-white uppercase transition ease-in-out hover:bg-violet-200 focus:outline-none focus:ring-0 duration- 150">CheckOut</button>
                            </td>
                        </tr>
                       </table> 
                    </form>
                    <div class="flex items-baseline pb-6 mt-4 mb-6 border-b border- slate-200">
                        Detail pemesanan dan juga fasilitas: pertunjukan yang memukau dan luar biasa dengan segala jenis pernak pernik didalamnya mengandung 
                        nilai dan norma saklar 
                        wisatawan juga dapat menikmai hidangan tradisional bali 
                    </div>
            ...
            Detail pemesanan dan juga fasilitas: pertunjukan yang memukau dan luar biasa dengan segala jenis pernak pernik didalamnya mengandung 
            nilai dan norma saklar dan dilakukan di tempat suci yang dimana perwujudan dewa siwa 
            </div>
            <div class="flex mb-5 space-x-4 text-sm font-medium">
                <div class="flex flex-auto space-x-4">
                    <!-- <button class="h-10 px-6 font-semibold text-white rounded-full bg-violet-600" type="submit">
...
<?php endif; ?><?php /**PATH D:\2 0 2 2\KULIAH SEMESTER 3 UNDIKSHA 2022\TEKNOLOGI WEB\Kecak\kecak\resources\views/detailpemesanan.blade.php ENDPATH**/ ?>